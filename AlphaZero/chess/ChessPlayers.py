...
class GTPChessPlayer():
    """
    Player that plays with Chess programs using the Go Text Protocol.
    """

    # The colours are reversed as the Chess programs seems to have the board setup with the opposite colours
    player_colors = {
        -1: "white",
         1: "black",
    }
    ...
    def notify(self, board, action):
        ...
        """
        color = GTPChessPlayer.player_colors[self._currentPlayer]
