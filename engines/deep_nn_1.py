...
class DeepNN1(ChessEngine):
    def __init__(self):
        # Load the mapping
        with open("./cnn/models/move_to_int", "rb") as file:
        ...
        self.model.load_state_dict(torch.load("./cnn/models/TORCH_100EPOCHS.pth", map_location=self.device, weights_only=False))
