...
import torch
from cnn.engines.torch.model import ChessModel2
import pickle
import numpy as np
...
class DeepNN2(ChessEngine):
    def __init__(self):
        # Load the mapping
        with open("./cnn/models/heavy_move_to_int2", "rb") as file:
        ...
        # Load the model
        self.model = ChessModel2(num_classes=len(move_to_int))
        self.model.load_state_dict(torch.load("./cnn/models/TORCH_50EPOCHS.pth", map_location=device, weights_only=False))
